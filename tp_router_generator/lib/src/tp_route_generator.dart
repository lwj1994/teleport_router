...
class TpRouterBuilder implements Builder {
  /// The prefix used for tp_router managed route names.
  /// This must match [kTpRoutePrefix] in tp_router package.
  static const _kRoutePrefix = 'tp_router_';
  ...
  String _generateShellRouteClass(
    ...
    if (route.isIndexedStack) {
      ...
      // Generate observersBuilder (TpRouteObserver is auto-injected via branchNavigatorKeys)
      ...
      */
      ...
      buffer.writeln('    ],');
      // Generate observers (TpRouteObserver is auto-injected via navigatorKey)
      if (route.observers.isNotEmpty) {
