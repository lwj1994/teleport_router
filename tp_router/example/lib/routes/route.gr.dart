...
class MainShellRoute {
  ...
  static final _branchKey0 = TpNavKey.value(navigatorKey.key, branch: 0);
  static final _branchKey1 = TpNavKey.value(navigatorKey.key, branch: 1);
  static final _branchKey2 = TpNavKey.value(navigatorKey.key, branch: 2);
