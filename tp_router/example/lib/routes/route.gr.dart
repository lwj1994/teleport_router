...
class MainShellRoute {
  ...
  static final _branchKey0 = TpNavigatorKeyRegistry.getOrCreate(TpNavKey.value(navigatorKey.key, branch: 0));
  static final _branchKey1 = TpNavigatorKeyRegistry.getOrCreate(TpNavKey.value(navigatorKey.key, branch: 1));
  static final _branchKey2 = TpNavigatorKeyRegistry.getOrCreate(TpNavKey.value(navigatorKey.key, branch: 2));
