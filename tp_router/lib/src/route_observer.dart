...
///
/// All routes generated by tp_router will have names starting with this prefix.
/// This is used by [TpRouteObserver] to identify and track tp_router routes.
const String kTpRoutePrefix = 'tp_router_';
...
class TpRouteObserver extends NavigatorObserver {
  ...
  ///
  /// Only tracks routes with names starting with [kTpRoutePrefix].
  bool _shouldTrackRoute(Route route) {
    final name = route.settings.name;
    return name != null && name.startsWith(kTpRoutePrefix);
  }
