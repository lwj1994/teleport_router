...
- [Page Configuration](#-page-configuration)
  - [Page Type (TpPageType)](#page-type-tppagetype)
...
- [Configuration](#-configuration)
  - [TpRouter Options](#tprouter-options)
...
See [go_router deep linking guide](https://pub.dev/documentation/go_router/latest/topics/Deep%20linking-topic.html) for platform-specific setup (TpRouter uses go_router internally).
