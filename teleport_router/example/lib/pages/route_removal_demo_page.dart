            ...
            children: [
              ...
              ElevatedButton.icon(
                ...
                onPressed: () {
                  ...
                  const RouteStackPageARoute().teleport();
                },
              ),
...
@TeleportRoute(path: '/route-stack/a')
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton.icon(
                ...
                onPressed: () {
                  const RouteStackPageBRoute().teleport();
                },
              ),
            ],
          ),
...
@TeleportRoute(path: '/route-stack/b')
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton.icon(
                ...
                onPressed: () async {
                  // First navigate to C
                  await const RouteStackPageCRoute().teleport();
                },
              ),
              const SizedBox(height: 16),
              OutlinedButton.icon(
                ...
                onPressed: () {
                  const RouteStackPageCRoute().teleport();
                },
              ),
            ],
          ),
...
@TeleportRoute(path: '/route-stack/c')
              ...
              if (!_removedB)
                ElevatedButton.icon(
                  ...
                  onPressed: () {
                    ...
                    // 当前是在主路由上的。
                    final removed = TeleportRouter.instance.removeRoute(
